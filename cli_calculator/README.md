...
- [x] Import `std::io` and use `std::io::stdin().read_line()` to grab user input as a String.
- [x] Use `.split_whitespace()` to isolate the numbers and the operator into separate variables.
